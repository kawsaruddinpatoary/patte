...
SECRET_KEY = 'django-insecure-k)54te**p!m^i=#k-jb(i-gum$#7&sl9ok@6(efbgo5yx0m1kc'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processor.user_data',
            ],
        },
    },
]
...
# Tells Django to look into your root static folder
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
